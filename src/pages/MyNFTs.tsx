...
const MyNFTs: React.FC = () => {
  ...
  const marketplaceAddr = "0x223d508f051f5869e232658de4a25c493813273319b5130ae54838c609be630d";
  ...
  const [nftToTransfer, setNftToTransfer] = useState<NFT | null>(null);
  ...
  return (
    ...
    >
      ...
      {isTransferModalVisible && nftToTransfer && (
      <TransferNFT 
        marketplaceAddr={marketplaceAddr} // Assuming marketplaceAddr is available in this scope
        nftId={nftToTransfer.id} 
        onClose={() => {
        setIsTransferModalVisible(false);
        setNftToTransfer(null);
        fetchUserNFTs(); // Call this to refresh NFTs after transfer
        }}
